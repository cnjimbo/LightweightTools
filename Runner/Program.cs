...
namespace Runner
{
    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                var outMessage = result.MapResult(SelfcallSuccessHandler,
                    errors => OkErrorString.Error(string.Join(Environment.NewLine, errors.Select(x => x.Tag.ToString()))));
        ...
        {
            return strIn.Aggregate(new SecureString(), (result, cur) =>
            {
        ...
        static Func<IOptions, OkErrorString> SelfcallSuccessHandler = opts =>
         {
